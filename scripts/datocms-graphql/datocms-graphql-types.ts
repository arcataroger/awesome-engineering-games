...
export type GameRecord = RecordInterface & {
  ...
  id: Scalars['ItemId']['output'];
  steamId?: Maybe<Scalars['String']['output']>;
...
export type MyQueryQuery = { __typename?: 'Query', allGames: Array<{ __typename?: 'GameRecord', id: string, steamId?: string | null, steamJson?: unknown | null, tags?: unknown | null, title?: string | null, curatorsThoughts?: string | null, _publishedAt?: string | null, _updatedAt: string, _status: ItemStatus, _isValid: boolean, capsuleImage?: { __typename?: 'FileField', id: string, _updatedAt: string, filename: string, md5: string, url: string } | null, headerImage?: { __typename?: 'FileField', id: string, _updatedAt: string, filename: string, md5: string, url: string } | null }> };

export type ResponsiveImageFragmentFragment = { __typename?: 'FileField', id: string, _updatedAt: string, filename: string, md5: string, url: string };
